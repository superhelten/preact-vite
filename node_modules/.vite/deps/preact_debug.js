...
` + f(this.__v)), v.call(this, n);
  ...
  var n = false, t = l.__b, r2 = l.diffed, s2 = l.vnode, u2 = l.__e, h2 = l.__, v2 = l.__h, m = p2 ? { useEffect: /* @__PURE__ */ new WeakMap(), useLayoutEffect: /* @__PURE__ */ new WeakMap(), lazyPropTypes: /* @__PURE__ */ new WeakMap() } : null, b = [];
  l.__e = function(n2, e, t2, o2) {
    ...
    if ("thead" !== r3 && "tfoot" !== r3 && "tbody" !== r3 || "table" === i2.type ? "tr" === r3 && "thead" !== i2.type && "tfoot" !== i2.type && "tbody" !== i2.type && "table" !== i2.type ? console.error("Improper nesting of table. Your <tr> should have a <thead/tbody/tfoot/table> parent." + y(e) + "\n\n" + f(e)) : "td" === r3 && "tr" !== i2.type ? console.error("Improper nesting of table. Your <td> should have a <tr> parent." + y(e) + "\n\n" + f(e)) : "th" === r3 && "tr" !== i2.type && console.error("Improper nesting of table. Your <th> should have a <tr>." + y(e) + "\n\n" + f(e)) : console.error("Improper nesting of table. Your <thead/tbody/tfoot> should have a <table> parent." + y(e) + "\n\n" + f(e)), void 0 !== e.ref && "function" != typeof e.ref && "object" != typeof e.ref && !("$$typeof" in e))
